...
void livid::newMidiMessage(ofxMidiMessage& msg) {
    ...
    //        Mgui->setRandomGrainSize1(ofMap(knobsB1[0],0,127,0.0,0.5));
        }
        if(midiMessage.control == 2){
            knobsB1[1] = midiMessage.value;
    //        Mgui->setRandomGrainPitch1(ofMap(knobsB1[1],0,127,0.0,0.5));
        }
        if(midiMessage.control == 3){
            knobsB1[2] = midiMessage.value;
    //        MguiBinaural->setBinVolume(ofMap(knobsB1[2],0,127,0.0,0.99));
        }
        
        if(midiMessage.control == 5){
            knobsB1[3] = midiMessage.value;
    //        Mgui->setRandomGrainSize2(ofMap(knobsB1[3],0,127,0.0,0.5));
        }
        if(midiMessage.control == 6){
            knobsB1[4] = midiMessage.value;
    //        Mgui->setRandomGrainPitch2(ofMap(knobsB1[4],0,127,0.0,0.5));
        }
        if(midiMessage.control == 7){
            knobsB1[5] = midiMessage.value;
    //        MguiBinaural->setBinPitch(ofMap(knobsB1[5],0,127,30.0,150.0));
        }
        
        if(midiMessage.control == 9){
            knobsB1[6] = midiMessage.value;
    //        Mgui->setRandomGrainSize3(ofMap(knobsB1[6],0,127,0.0,0.5));
        }
        if(midiMessage.control == 10){
            knobsB1[7] = midiMessage.value;
    //        Mgui->setRandomGrainPitch3(ofMap(knobsB1[7],0,127,0.0,0.5));
        }
        if(midiMessage.control == 11){
            knobsB1[8] = midiMessage.value;
    //        MguiBinaural->setBinOffset(ofMap(knobsB1[8],0,127,0.0,14.0));
        }
        
        if(midiMessage.control == 13){
            knobsB1[9] = midiMessage.value;
    //        Mgui->setRandomGrainSize4(ofMap(knobsB1[9],0,127,0.0,0.5));
        }
        if(midiMessage.control == 14){
            knobsB1[10] = midiMessage.value;
    //        Mgui->setRandomGrainPitch4(ofMap(knobsB1[10],0,127,0.0,0.5));
        }
        ...
        if(midiMessage.control == 17){
            ...
            Mgui->setPitch1(ofMap(knobsB3[0],0,127,0.0,8.0));
        }
        if(midiMessage.control == 18){
            knobsB3[1] = midiMessage.value;
            Mgui->setGrainSize1(ofMap(knobsB3[1],0,127,0.025,0.49));
        }
	...
	//Button 13
    //Swith the livid controller between Kortex and Shamanic Audio
	if(midiMessage.pitch == 3 && midiMessage.velocity == 64){
        if(bIsTurningOn[12]==false){
            if(buttonsState[0]==0){
                buttonsState[0]++;
            } else {
                buttonsState[0]--;
            ...
            buttons[12] = true;
            bSwitchMidi=(!(bool)buttonsState[0]);
            cout << "shamainc midi = " << bSwitchMidi << endl;
            bIsTurningOn[12] = true;
            bIsTurningOff[12] = false;
        }
    ...
    /////////////////////////////////// GRANULAR SYNTHESIS PRESETS /////////////////////////////////////////////////////

	//Button 5
	if(midiMessage.pitch == 20 && midiMessage.velocity == 64){
        if(bButtonsR1IsTurningOn[4]==false){
            buttonsR1[4] = true;
            Mgui->triggerPreset1(buttonsR1[4]);
            bButtonsR1IsTurningOn[4] = true;
            bButtonsR1IsTurningOff[4] = false;
        }
	} else if((midiMessage.pitch == 20) && midiMessage.velocity == 0){
        if(bButtonsR1IsTurningOff[4]==false){
            buttonsR1[4] = false;
            bButtonsR1IsTurningOff[4]=true;
            bButtonsR1IsTurningOn[4] = false;
        }
	}
	
	//Button 6
	if(midiMessage.pitch == 21 && midiMessage.velocity == 64){
        if(bButtonsR1IsTurningOn[5]==false){
            buttonsR1[5] = true;
            Mgui->triggerPreset2(buttonsR1[5]);
            bButtonsR1IsTurningOn[5] = true;
            bButtonsR1IsTurningOff[5] = false;
        }
	} else if((midiMessage.pitch == 21) && midiMessage.velocity == 0){
        if(bButtonsR1IsTurningOff[5]==false){
            buttonsR1[5] = false;
            bButtonsR1IsTurningOff[5]=true;
            bButtonsR1IsTurningOn[5] = false;
        }
	}
	
	//Button 7
	if(midiMessage.pitch == 22 && midiMessage.velocity == 64){
        if(bButtonsR1IsTurningOn[6]==false){
            buttonsR1[6] = true;
            Mgui->triggerPreset3(buttonsR1[6]);
            bButtonsR1IsTurningOn[6] = true;
            bButtonsR1IsTurningOff[6] = false;
        }
	} else if((midiMessage.pitch == 22) && midiMessage.velocity == 0){
        if(bButtonsR1IsTurningOff[6]==false){
            buttonsR1[6] = false;
            bButtonsR1IsTurningOff[6]=true;
            bButtonsR1IsTurningOn[6] = false;
        }
	}
	
	//Button 8
	if(midiMessage.pitch == 23 && midiMessage.velocity == 64){
        if(bButtonsR1IsTurningOn[7]==false){
            buttonsR1[7] = true;
            Mgui->triggerPreset4(buttonsR1[7]);
            bButtonsR1IsTurningOn[7] = true;
            bButtonsR1IsTurningOff[7] = false;
        }
	} else if((midiMessage.pitch == 23) && midiMessage.velocity == 0){
        if(bButtonsR1IsTurningOff[7]==false){
            buttonsR1[7] = false;
            bButtonsR1IsTurningOff[7]=true;
            bButtonsR1IsTurningOn[7] = false;
        }
	}
	
	//Button 9
	if(midiMessage.pitch == 24 && midiMessage.velocity == 64){
        if(bButtonsR1IsTurningOn[8]==false){
            buttonsR1[8] = true;
            Mgui->triggerPreset5(buttonsR1[8]);
            bButtonsR1IsTurningOn[8] = true;
            bButtonsR1IsTurningOff[8] = false;
        }
	} else if((midiMessage.pitch == 24) && midiMessage.velocity == 0){
        if(bButtonsR1IsTurningOff[8]==false){
            buttonsR1[8] = false;
            bButtonsR1IsTurningOff[8]=true;
            bButtonsR1IsTurningOn[8] = false;
        }
	}
	
	//Button 10
	if(midiMessage.pitch == 25 && midiMessage.velocity == 64){
        if(bButtonsR1IsTurningOn[9]==false){
            buttonsR1[9] = true;
            Mgui->triggerPreset6(buttonsR1[9]);
            bButtonsR1IsTurningOn[9] = true;
            bButtonsR1IsTurningOff[9] = false;
        }
	} else if((midiMessage.pitch == 25) && midiMessage.velocity == 0){
        if(bButtonsR1IsTurningOff[9]==false){
            buttonsR1[9] = false;
            bButtonsR1IsTurningOff[9]=true;
            bButtonsR1IsTurningOn[9] = false;
        }
	}
	
	//Button 11
	if(midiMessage.pitch == 26 && midiMessage.velocity == 64){
        if(bButtonsR1IsTurningOn[10]==false){
            buttonsR1[10] = true;
            Mgui->triggerPreset7(buttonsR1[10]);
            bButtonsR1IsTurningOn[10] = true;
            bButtonsR1IsTurningOff[10] = false;
        }
	} else if((midiMessage.pitch == 26) && midiMessage.velocity == 0){
        if(bButtonsR1IsTurningOff[10]==false){
            buttonsR1[10] = false;
            bButtonsR1IsTurningOff[10]=true;
            bButtonsR1IsTurningOn[10] = false;
        }
	}
	
	//Button 12
	if(midiMessage.pitch == 27 && midiMessage.velocity == 64){
        if(bButtonsR1IsTurningOn[11]==false){
            buttonsR1[11] = true;
            Mgui->triggerPreset8(buttonsR1[11]);
            bButtonsR1IsTurningOn[11] = true;
            bButtonsR1IsTurningOff[11] = false;
        }
	} else if((midiMessage.pitch == 27) && midiMessage.velocity == 0){
        if(bButtonsR1IsTurningOff[11]==false){
            buttonsR1[11] = false;
            bButtonsR1IsTurningOff[11]=true;
            bButtonsR1IsTurningOn[11] = false;
        }
	}
    ...
    /////////////////////////////////// BINAURAL SYNTH PRESETS /////////////////////////////////////////////////////
	
	//Button 5
	if(midiMessage.pitch == 36 && midiMessage.velocity == 64){
        if(bButtonsR2IsTurningOn[4]==false){
            buttonsR2[4] = true;
            MguiBinaural->triggerSynthPreset1(buttonsR2[4]);
            bButtonsR2IsTurningOn[4] = true;
            bButtonsR2IsTurningOff[4] = false;
        }
	} else if((midiMessage.pitch == 36) && midiMessage.velocity == 0){
        if(bButtonsR2IsTurningOff[4]==false){
            buttonsR2[4] = false;
            bButtonsR2IsTurningOff[4]=true;
            bButtonsR2IsTurningOn[4] = false;
        }
	}
	
	//Button 6
	if(midiMessage.pitch == 37 && midiMessage.velocity == 64){
        if(bButtonsR2IsTurningOn[5]==false){
            buttonsR2[5] = true;
            MguiBinaural->triggerSynthPreset2(buttonsR2[5]);
            bButtonsR2IsTurningOn[5] = true;
            bButtonsR2IsTurningOff[5] = false;
        }
	} else if((midiMessage.pitch == 37) && midiMessage.velocity == 0){
        if(bButtonsR2IsTurningOff[5]==false){
            buttonsR2[5] = false;
            bButtonsR2IsTurningOff[5]=true;
            bButtonsR2IsTurningOn[5] = false;
        }
	}
	
	//Button 7
	if(midiMessage.pitch == 38 && midiMessage.velocity == 64){
        if(bButtonsR2IsTurningOn[6]==false){
            buttonsR2[6] = true;
            MguiBinaural->triggerSynthPreset3(buttonsR2[6]);
            bButtonsR2IsTurningOn[6] = true;
            bButtonsR2IsTurningOff[6] = false;
        }
	} else if((midiMessage.pitch == 38) && midiMessage.velocity == 0){
        if(bButtonsR2IsTurningOff[6]==false){
            buttonsR2[6] = false;
            bButtonsR2IsTurningOff[6]=true;
            bButtonsR2IsTurningOn[6] = false;
        }
	}
	
	//Button 8
	if(midiMessage.pitch == 39 && midiMessage.velocity == 64){
        if(bButtonsR2IsTurningOn[7]==false){
            buttonsR2[7] = true;
            MguiBinaural->triggerSynthPreset4(buttonsR2[7]);
            bButtonsR2IsTurningOn[7] = true;
            bButtonsR2IsTurningOff[7] = false;
        }
	} else if((midiMessage.pitch == 39) && midiMessage.velocity == 0){
        if(bButtonsR2IsTurningOff[7]==false){
            buttonsR2[7] = false;
            bButtonsR2IsTurningOff[7]=true;
            bButtonsR2IsTurningOn[7] = false;
        }
	}
	
	//Button 9
	if(midiMessage.pitch == 40 && midiMessage.velocity == 64){
        if(bButtonsR2IsTurningOn[8]==false){
            buttonsR2[8] = true;
            MguiBinaural->triggerSynthPreset5(buttonsR2[8]);
            bButtonsR2IsTurningOn[8] = true;
            bButtonsR2IsTurningOff[8] = false;
        }
	} else if((midiMessage.pitch == 40) && midiMessage.velocity == 0){
        if(bButtonsR2IsTurningOff[8]==false){
            buttonsR2[8] = false;
            bButtonsR2IsTurningOff[8]=true;
            bButtonsR2IsTurningOn[8] = false;
        }
	}
	
	//Button 10
	if(midiMessage.pitch == 41 && midiMessage.velocity == 64){
        if(bButtonsR2IsTurningOn[9]==false){
            buttonsR2[9] = true;
            MguiBinaural->triggerSynthPreset6(buttonsR2[9]);
            bButtonsR2IsTurningOn[9] = true;
            bButtonsR2IsTurningOff[9] = false;
        }
	} else if((midiMessage.pitch == 41) && midiMessage.velocity == 0){
        if(bButtonsR2IsTurningOff[9]==false){
            buttonsR2[9] = false;
            bButtonsR2IsTurningOff[9]=true;
            bButtonsR2IsTurningOn[9] = false;
        }
	}
	
	//Button 11
	if(midiMessage.pitch == 42 && midiMessage.velocity == 64){
        if(bButtonsR2IsTurningOn[10]==false){
            buttonsR2[10] = true;
            MguiBinaural->triggerSynthPreset7(buttonsR2[10]);
            bButtonsR2IsTurningOn[10] = true;
            bButtonsR2IsTurningOff[10] = false;
        }
	} else if((midiMessage.pitch == 42) && midiMessage.velocity == 0){
        if(bButtonsR2IsTurningOff[10]==false){
            buttonsR2[10] = false;
            bButtonsR2IsTurningOff[10]=true;
            bButtonsR2IsTurningOn[10] = false;
        }
	}
	
	//Button 12
	if(midiMessage.pitch == 43 && midiMessage.velocity == 64){
        if(bButtonsR2IsTurningOn[11]==false){
            buttonsR2[11] = true;
            MguiBinaural->triggerSynthPreset8(buttonsR2[11]);
            bButtonsR2IsTurningOn[11] = true;
            bButtonsR2IsTurningOff[11] = false;
        }
	} else if((midiMessage.pitch == 43) && midiMessage.velocity == 0){
        if(bButtonsR2IsTurningOff[11]==false){
            buttonsR2[11] = false;
            bButtonsR2IsTurningOff[11]=true;
            bButtonsR2IsTurningOn[11] = false;
        }
	}
