...
class Gui {
	...
	void setup(Tween *_tween1, Tween *_tween2, Tween *_tween3, Tween *_tween4, AudioTonic *_audioTonic, AudioBinaural *_audioBinaural, AudioSampler *_audioSample1, AudioSampler *_audioSample2, AudioSampler *_audioSample3, AudioSampler *_audioSample4);
